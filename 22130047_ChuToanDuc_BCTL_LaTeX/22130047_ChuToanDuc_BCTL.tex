...
dấu tích thứ nhất và backbone hình dấu tích thứ hai.
...
\phantomsection\label{_Toc236751527}{}\includegraphics[width=4.2197in,height=4.2197in]{22130047_ChuToanDuc_BCTL_media/media/image9.jpeg}Hình
...
Bước 7: GAP nén bản đồ đặc trưng 3D thành vector 1D, lớp phân loại tạo
...
khối FR-PDP, chèn CBAM toàn cục có kết nối tàn dư tại 3 điểm nối chiến
lược:
...
Hooking Point 3: Sau lớp Final Conv \(1 \times 1\)(1024 kênh), trước lớp
Global Average Pooling.

Mỗi mô-đun CBAM tại các điểm nối sử dụng tỷ lệ giảm kênh \(r = 8\ \)và
kích thước kernel SAM \(7 \times 7\ \)để tận dụng vùng tiếp nhận tích
lũy lớn. Tổng số tham số huấn luyện: khoảng 2.379.966 tham số (tăng
khoảng 19,8\% so với baseline, vẫn giữ ở mức siêu nhẹ dưới 2,5 triệu
tham số).
\end{quote}
